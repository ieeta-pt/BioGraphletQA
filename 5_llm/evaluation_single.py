...
parser.add_argument("--checkpoint", type=str, required=True, help="Path to directory containing checkpoints.")
...
output_file = f"{PATH_TO_CONSTANTS}/_llm_outs/eval_outputs_new_qa/{args.output_template}_E{0}.jsonl"
run_eval(args.checkpoint, output_file)
