...
# python new_new_eval_single.py \
#   --checkpoint "unsloth/gemma-3-12b-it" \
#   --output_template "E0"

python new_new_eval_single.py \
  --checkpoint "../_model/gemma-3-12b-ft-custom-E3/checkpoint-1873" \
  --output_template "E1"


python new_new_eval_single.py \
  --checkpoint "../_model/gemma-3-12b-ft-custom-E3/checkpoint-3746" \
  --output_template "E2"


python new_new_eval_single.py \
  --checkpoint "../_model/gemma-3-12b-ft-custom-E3/checkpoint-5619" \
  --output_template "E3"
...
# python unsloth_trainer_bioasq_new_qa.py \
#     --model_checkpoint "../_model/_new_models/gemma-3-12b-ft-custom-E3/checkpoint-1873" \
